...
class TickBarsTestCase(unittest.TestCase):
	...
	def test_make_bars(self):
		...
		tests = [
				(1, 0, mock_data, pd.DataFrame(columns = ['Open', 'High', 'Low', 'Close'], index = [])), # test returns empty dataframe
				(2, 1, mock_data, pd.DataFrame(data = [
														[10, 10, 10, 10],
														[11, 11, 11, 11],
														[13, 13, 13, 13],
														[ 9,  9,  9,  9],
				...
				(3, 2, mock_data, pd.DataFrame(data = [
														[10, 11, 10, 11],
														[13, 13, 9, 9]],
												columns = ['Open', 'High', 'Low', 'Close'], 
				...
				(7, 6, mock_data, pd.DataFrame(columns = ['Open', 'High', 'Low', 'Close'], index = [])), # testing more ticks than dataframe holds => empty df
				(8, 2, [
						['2023-08-29 00:00:00',     '10.9999', '1'],
					 	['2023-08-29 00:00:01',          '11', '5'], # test resetting high comparing int to float
					 	['2023-08-29 00:00:03', '10.99999999', '3'],
					 	['2023-08-29 00:00:04',        '11.0', '2'], # test as above with float to float comparison (precision to 8 dec places)
				 	 	['2023-08-29 00:00:09',        '12.0', '3'],
				 	 	['2023-08-29 00:00:12',           '8', '4'], # resets low
				 	 	['2023-08-29 00:00:13',        '12.0', '3'],
				 	 	['2023-08-29 00:00:17', '11.99999999', '4'] # resets low, float to float, 8 dec precision
				 	 	],
				 	 	pd.DataFrame(data = [
											[10.9999, 11.0, 10.9999, 11.0],
...
class TimeBarsTestCase(unittest.TestCase):
	...
	def test_make_bars(self):
		...
		tests = [
				(1, 0, 'seconds', mock_data, pd.DataFrame(columns = ['Open', 'High', 'Low', 'Close'], index = [])), # returns empty dataframe
				(2, 1, 'seconds', mock_data, pd.DataFrame(data = [
																	[10, 10, 10, 10],
																	[11, 11, 11, 11],
				...
				(3, 2, 'seconds', mock_data, pd.DataFrame(data = [
																	[10, 11, 10, 11],
																	[13, 13, 13, 13],
																	[ 9,  9,  9,  9],
																	[np.nan, np.nan, np.nan, np.nan],
				...
				(4, 4, 'seconds', mock_data, pd.DataFrame(data = [
																	[10, 13, 10, 13],
																	[ 9,  9,  9,  9],
																	[12, 12, 12, 12]],
															columns = ['Open', 'High', 'Low', 'Close'],
				...
				(9, 30, 'minutes', [
									['2023-05-12 04:00:00.0',     '116.57', '90'],
...
class VolumeBarsTestCase(unittest.TestCase):
	...
	def test_make_bars(self):
		...
		# List of tuples of (test_number, threshold, test_data, solution)
		tests = [
				(1, 0, mock_data, pd.DataFrame(columns = ['Open', 'High', 'Low', 'Close'], index = [])), # zero volume should return empty dataframe
